...
async function reverseGeocode(lat: number, lng: number): Promise<AddressDetails> {
    try {
        ...
        return {
            ...
            state: addr.state || addr["ISO3166-2-lvl4"] || "",
        ...
        return { display_name: "", state: "", city: "", district: "", suburb: "", village: "", postcode: "" };
    }
}
...
export default function MapPicker({ onLocationSelect, initialLat, initialLng }: MapPickerProps) {
    ...
    const selectLocation = useCallback(
        async (lat: number, lng: number) => {
            ...
            onLocationSelect(lat, lng, details.display_name, details);
        },
        [onLocationSelect]
    );
