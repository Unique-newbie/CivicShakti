...
import {
    ...
    MapPin, Eye, EyeOff, Zap, Award, BarChart3
} from "lucide-react";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                                ...
                                {!showChangePw ? (
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-2 pt-1">
                                            <Button type="submit" size="sm" className="bg-blue-600 hover:bg-blue-700 text-white" disabled={pwLoading}>
                                                {pwLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Save'}
                                            </Button>
                        ...
                        <Card className="rounded-sm border-slate-200 shadow-none">
                            <CardHeader className="pb-3">
                                <CardTitle className="text-sm font-semibold text-slate-700 flex items-center gap-2">
                                    <ShieldCheck className="w-4 h-4 text-slate-400" /> Privacy & Data
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-3">
