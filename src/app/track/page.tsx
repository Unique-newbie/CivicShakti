            ...
            <main className="flex-1 flex flex-col items-center justify-center p-4">
                <div className="w-full max-w-md bg-white rounded-sm shadow-none overflow-hidden border border-slate-300 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="p-6 md:p-8">
                        <Link href="/" className="inline-flex items-center text-sm text-slate-500 hover:text-slate-800 mb-6 transition-colors font-medium">
                            <ArrowLeft className="w-4 h-4 mr-1" /> Back to Home
                        </Link>

                        <h1 className="text-2xl font-bold tracking-tight text-slate-900 mb-2">Track your complaint</h1>
                        <p className="text-slate-500 mb-8 leading-relaxed">
                            Enter the tracking ID you received when you submitted your report to see its real-time status.
                        </p>
                        ...
                        <form onSubmit={handleSearch} className="space-y-4">
                            ...
                            >
                                {isLoading ? <Loader2 className="w-5 h-5 animate-spin mr-2" /> : "Track Status"}
                            </Button>
                        </form>
                    </div>
